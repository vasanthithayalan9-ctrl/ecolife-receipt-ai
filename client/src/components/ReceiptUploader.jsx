    ...
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-emerald-300">Receipt Uploader</p>
            <h2 className="mt-1 text-2xl font-semibold text-white">Upload a receipt or preview a sample</h2>
          </div>
        </div>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[1.5rem] border border-dashed border-emerald-400/40 bg-emerald-950/70 p-8 text-center text-emerald-100/80">
          ...
          <p className="mt-4 text-lg font-semibold text-white">Receipt upload area</p>
          <p className="mt-2 text-sm text-emerald-100/70">Modern intake experience with guided OCR support and premium previews.</p>
        </div>

        <div className="rounded-[1.5rem] border border-emerald-700/40 bg-emerald-900/80 p-6">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-emerald-300">Preview</p>
          <div className="mt-4 space-y-3">
            {demoLoaded ? (
              ...
              <div className="rounded-2xl border border-emerald-700/40 bg-emerald-950/70 px-4 py-5 text-sm text-emerald-100/70">
                Click the button to explore a sample receipt before analysis.
              </div>
            )}
          </div>
        </div>
