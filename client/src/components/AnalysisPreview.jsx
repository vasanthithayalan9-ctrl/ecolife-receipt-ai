  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-emerald-300">Analysis Preview</p>
          <h2 className="mt-1 text-2xl font-semibold text-white">Eco score and alternatives</h2>
        </div>
      </div>

      <div className="mt-6 grid gap-4 md:grid-cols-2">
        <div className="rounded-[1.4rem] border border-emerald-700/40 bg-emerald-950/70 p-5">
          <p className="text-sm text-emerald-200/70">Overall eco score</p>
          <p className="mt-2 text-4xl font-semibold text-emerald-300">82/100</p>
        </div>
        <div className="rounded-[1.4rem] border border-emerald-700/40 bg-emerald-950/70 p-5">
          <p className="text-sm text-emerald-200/70">Suggested alternatives</p>
          <ul className="mt-3 space-y-2 text-sm text-emerald-100/80">
            <li>• Swap plastic bottle for reusable bottle</li>
            <li>• Choose local produce over imported goods</li>
          </ul>
        </div>
      </div>
    </motion.section>
